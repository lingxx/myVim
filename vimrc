...
map ,m :!markdown % > %:r.html<CR>
map ,p :!cat github.css %:r.html > index.html<CR>

"vimwiki
let g:vimwiki_list = [{'path': '~/myfile/ddling/vimwiki/',
    \ 'css_name': '../lib/bootstrap/css/bootstrap.css',
    \ 'path_html': '~/myfile/ddling/html/',}]
let g:vimwiki_valid_html_tags='b,i,s,u,sub,sup,kbd,br,hr,div,del,code,img,copy'
